...
namespace TPL_TAP
{
    internal class TasksTest
    {
        ...
        private static void TaskMethod()
        {
            ...
            Console.WriteLine("ThrdID:{0} TaskID:{1} - ended", Thread.CurrentThread.ManagedThreadId, Task.CurrentId);
        }
        private static int GetMessageLength(string msg, int Timeout = 1000)
        {
            Console.WriteLine("Входные дaнные:\"{0}\"", msg ?? "<null>");
            ...
            Console.WriteLine("ThrdID:{0} TaskID:{1} - ended : msg = {2}", Thread.CurrentThread.ManagedThreadId, Task.CurrentId, msg);
