...
namespace MailSender.lib.Data
{
    public static class TestData
    {
        ...
        */
        ...
        public static List<Server> Servers { get; } = new List<Server>
        {
            new Server { Id = 1, Name = "Яндекс", Address = "smtp.yandex.ru", Port = 587, Login = "UserLogin", Password = "Password".Encode(3) },
            new Server { Id = 2, Name = "Mail.ru", Address = "smtp.mail.ru", Port = 587, Login = "UserLogin", Password = "Password".Encode(3) },
            new Server { Id = 3, Name = "GMail", Address = "smtp.gmail.com", Port = 587, Login = "UserLogin", Password = "Password".Encode(3) },
        };
    }
}
